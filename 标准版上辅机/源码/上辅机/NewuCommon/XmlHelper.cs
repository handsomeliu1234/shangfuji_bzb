...
namespace NewuCommon
{
    ...
    public class XmlHelper : IDisposable
    {
        ...
        public XmlNode XmlNode(string xmlPath, string ParentNode, string findNode)
        {
            XmlNode node = null;

            XmlDocument docXml = new XmlDocument();
            docXml.Load(xmlPath);
            XmlNode xn = docXml.SelectSingleNode(ParentNode);

            foreach (XmlNode item in xn.ChildNodes)
            {
                if (item.Name == findNode)
                {
                    node = item;
                    break;
                }
        ...
        public void XmlModifyAttribute(string xmlPath, string ParentNode, string findNode, string atrributeValue)
        {
            XmlDocument docXml = new XmlDocument();
            docXml.Load(xmlPath);
            XmlNode xn = docXml.SelectSingleNode(ParentNode);
            ...
            foreach (XmlNode item in xn.ChildNodes)
            {
                if (item.Name == findNode)
                {
                    item.Attributes["IP"].Value = atrributeValue;
                    docXml.Save(xmlPath);
                }
            }
        }

        public void XmlDeleteNode(string xmlPath, string ParentNode, string delNode)
        {
            XmlDocument docXml = new XmlDocument();
            docXml.Load(xmlPath);
            XmlNode xn = docXml.SelectSingleNode(ParentNode);
        ...
        /// <returns></returns>
        public XmlNode ReadXmlNode(string XmlPath, string NodeName)
        {
            XmlDocument docXml = new XmlDocument();
            docXml.Load(@XmlPath);
            XmlNode xn = docXml.SelectSingleNode(NodeName);
            return xn;
        }

        #endregion 读取XML到DataSet
 ...
 ************************************************/
        ...
        public void XmlNodeReplace(string xmlPath, string Node, string Content)
        {
            XmlDocument objXmlDoc = new XmlDocument();
            objXmlDoc.Load(xmlPath);
            objXmlDoc.DocumentElement.SelectSingleNode(Node).InnerText = Content;
 ...
 ************************************************/
        ...
        public void XmlNodeDelete(string xmlPath, string Node)
        {
            try
            {
                XmlDocument objXmlDoc = new XmlDocument();
 ...
 ************************************************/
        ...
        public void XmlInsertNode(string xmlPath, string MailNode, string ChildNode, string Element, string Content)
        {
            XmlDocument objXmlDoc = new XmlDocument();
            objXmlDoc.Load(xmlPath);
 ...
 ************************************************/
        ...
        public void XmlInsertElement(string xmlPath, string MainNode, string Element, string Attrib, string AttribContent, string Content)
        {
            XmlDocument objXmlDoc = new XmlDocument();
            objXmlDoc.Load(xmlPath);
 ...
 ************************************************/
        ...
        public void XmlInsertElement(string xmlPath, string MainNode, string Element, string Content)
        {
            XmlDocument objXmlDoc = new XmlDocument();
            objXmlDoc.Load(xmlPath);
            XmlNode objNode = objXmlDoc.SelectSingleNode(MainNode);
 ...
 ************************************************/
        ...
        #endregion 在当前节点的插入一个仅带2个属性值的节点
 ...
 ************************************************/
        ...
        /// <returns></returns>
        public System.Collections.ArrayList GetSubElementByAttribute(string XmlPath, string FatherElenetName, string AttributeName, int AttributeIndex, int ArrayLength)
        {
