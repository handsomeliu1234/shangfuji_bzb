...
{
    public partial class MixPartFinal : UserControl
    {
        public MixPartFinal()
        {
            InitializeComponent();
        ...
        public void SetMixShuanLocation(bool high, bool mid, bool low)
        {
            ...
            if (high)
            {
                this.NewuShuanLocation = ShuanLocation.high;
            }
            else if (mid)
            {
                this.NewuShuanLocation = ShuanLocation.middle;
            }
            else if (low)
            {
                this.NewuShuanLocation = ShuanLocation.low;
            }
        }
    }
}