...
namespace NewuCommon
{
    public partial class UserProgress : ProgressBar
    {
        public UserProgress()
        {
            ...
            //base.SetStyle(ControlStyles.AllPaintingInWmPaint, true);//减少闪烁
            //base.SetStyle(ControlStyles.OptimizedDoubleBuffer, true);//减少闪烁
            //base.SetStyle(ControlStyles.DoubleBuffer, true);//减少闪烁
            //base.SetStyle(ControlStyles.ResizeRedraw, true);//重绘控件
            //base.SetStyle(ControlStyles.SupportsTransparentBackColor, true);//减少闪烁
        }
