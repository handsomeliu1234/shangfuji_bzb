...
{
    public class CurrentRunInfoUtil
    {
        ...
        public CurrentRunInfoUtil()
        {
            IsHistoryMode = false;
        }

        public CurrentRunInfoUtil(bool _isHistoryMode)
        {
            IsHistoryMode = true;
        }
        ...
        public void ScaleRealTimeRun(DevicePartType part, int setBatch, int realBatch, int weightNo)
        {
            ...
            if (temp.SetBatch != setBatch || temp.RealBatch != realBatch || temp.WeightNo != weightNo)
            {
                ...
                if (ScaleRawChangeEvent != null)
                    ScaleRawChangeEvent(part, temp);
            }
        }
    }
}