...
{
    public partial class US_Carbon_6_Oil_1 : UserControl, ILanguageChanged
    {
        ...
        private void Carbon_6_Oill_1_Load(object sender, EventArgs e)
        {
            SetControlLanguageText();
            //加载储罐的名字
            LoadCarbonBinName();
