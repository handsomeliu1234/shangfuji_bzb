...
{
    public partial class US_Carbon_8_Oil_1_series : UserControl, ILanguageChanged
    {
        ...
        public US_Carbon_8_Oil_1_series()
        {
            InitializeComponent();
        }
        ...
        private void US_Carbon_8_Oil_1_series_Load(object sender, EventArgs e)
        {
            SetControlLanguageText();
            //加载储罐的名字
            LoadCarbonBinName();
