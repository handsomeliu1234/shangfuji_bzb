...
{
    public partial class US_Carbon_6_Oil_5 : UserControl, ILanguageChanged
    {
        ...
        private void US_Carbon_6_Oil_5_Load(object sender, EventArgs e)
        {
            SetControlLanguageText();
            //加载储罐的名字
            LoadCarbonBinName();
        ...
        private void LoadCarbonBinName()
        {
            ...
            {
                NewuGlobal.LogCat("US_Carbon_6_Oill_5").Error(ex.ToString());
            }
        }
