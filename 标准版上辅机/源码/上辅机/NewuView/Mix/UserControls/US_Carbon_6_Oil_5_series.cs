...
{
    public partial class US_Carbon_6_Oil_5_series : UserControl, ILanguageChanged
    {
        ...
        public US_Carbon_6_Oil_5_series()
        {
            InitializeComponent();
        }
        ...
        private void US_Carbon_6_Oil_5_series_Load(object sender, EventArgs e)
        {
            SetControlLanguageText();
            //加载储罐的名字
            LoadCarbonBinName();
        ...
        private void LoadCarbonBinName()
        {
            ...
            {
                NewuGlobal.LogCat("US_Carbon_6_Oill_5_series").Error(ex.ToString());
            }
        }
        ...
        private void DisPlayYiBiao()
        {
            try
            {
                ...
                ScaleDisPlay.Scale_M_D(YiBiaoTimeTime);
            }
            catch (Exception ex)
            {
                NewuGlobal.LogCat("US_Carbon_6_Oill_5_series").Error(ex.ToString());
        ...
        private void DisPlayOilScale()
        {
            try
            {
                ...
                if (xie)
                    ...
                    Utils.SetPipeStyle(uc_O1, false, Color.Brown);
