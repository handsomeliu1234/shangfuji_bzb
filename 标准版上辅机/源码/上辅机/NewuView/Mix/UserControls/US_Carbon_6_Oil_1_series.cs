...
{
    public partial class US_Carbon_6_Oil_1_series : UserControl, ILanguageChanged
    {
        ...
        public US_Carbon_6_Oil_1_series()
        {
            InitializeComponent();
        }
        ...
        private void US_Carbon_6_Oil_1_series_Load(object sender, EventArgs e)
        {
            SetControlLanguageText();
            //加载储罐的名字
            LoadCarbonBinName();
        ...
        private void LoadCarbonBinName()
        {
            ...
            {
                NewuGlobal.LogCat("Carbon_6_Oill_1").Error(ex.ToString());
            }
        }
