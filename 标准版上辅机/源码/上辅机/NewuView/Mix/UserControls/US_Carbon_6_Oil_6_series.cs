...
{
    public partial class US_Carbon_6_Oil_6_series : UserControl, ILanguageChanged
    {
        ...
        public US_Carbon_6_Oil_6_series()
        {
            InitializeComponent();
        }
        ...
        private void US_Carbon_6_Oil_6_series_Load(object sender, EventArgs e)
        {
            SetControlLanguageText();
            //加载储罐的名字
            LoadCarbonBinName();
