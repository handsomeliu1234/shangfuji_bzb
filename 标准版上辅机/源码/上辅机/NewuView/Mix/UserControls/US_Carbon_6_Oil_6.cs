...
{
    public partial class US_Carbon_6_Oil_6 : UserControl, ILanguageChanged
    {
        private PLC_Connection_State plcConnectionState = PLC_Connection_State.GetInstance();
        ...
        private void US_Carbon_6_Oil_6_Load(object sender, EventArgs e)
        {
            SetControlLanguageText();
            //加载储罐的名字
            LoadCarbonBinName();
        ...
        private void LoadCarbonBinName()
        {
            ...
            {
                NewuGlobal.LogCat("US_Carbon_6_Oill_6").Error(ex.ToString());
            }
        }
        ...
        private void DisPlayReCycCarbonBin()
        {
            try
            {
                ...
                if (result)
                {
                    ReCycPipe11.LiquidSpeed = ReCycPipe12.LiquidSpeed = 50;
                    ReCycPipe11.LiquidColor = ReCycPipe12.LiquidColor = Color.Black;
                    ReCycluoXuan1.NewuRunState = 1;
                }
                else
                {
                    ReCycPipe11.LiquidColor = ReCycPipe12.LiquidColor = Color.Silver;
