...
{
    public partial class Base_Monitor_M : Form
    {
        ...
        {
            // 回收斗
            ReCycBin1.NewuSet料位(SS.getInt(37063, 4));
            // 炭黑 1 - 8 斗
        ...
        {
            bool temp = SS.getbool(716);
            ReCycPipe11.setImageTag(temp);
            ReCycPipe12.setImageTag(temp);
            ReCycPipe13.setImageTag(temp);
        }
        /// <summary>
        /// 炭黑 下料界面显示 
        /// </summary>
        void DisPlayCarbonScale()
        {
            ...
            //炭黑中间斗有料
            CarbonScaleMidBin.setImageTag(SS.getbool(605));
            //卸炭黑
            FaCarbonScale.setImageTag(SS.getbool(720));
            PipeCarbonScale.setImageTag(SS.getbool(720));
            //炭黑排错位
            if (SS.getbool(726))
            {
        ...
        void DisPlaySilScale()
        {
            ...
            if (SS.getbool(828))
            {
                faSil02.NewuPicTypeStyle = NewuControl.NewuPicType.Background;
                PipeSil21.NewuPicTypeStyle = NewuControl.NewuPicType.Background;
            }
            else
            {
                faSil02.NewuPicTypeStyle = NewuControl.NewuPicType.Foreground;
                PipeSil21.NewuPicTypeStyle = NewuControl.NewuPicType.Foreground;
            }

            //硅烷 中间斗有料
            SilScaleMidBin01.setImageTag(SS.getbool(669));
            //硅烷称称好
            SilScaleBin01.setImageTag(SS.getbool(667));
        }
        /// <summary>
        ...
        void DisPlayRubberScale()
        {
            ...
            Scale_Pla.setScaleState(SS.getbool(718), SS.getbool(714));
